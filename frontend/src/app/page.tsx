  ...
  return (
    <div style={{ padding: '24px 0' }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 16, color: '#666' }}>Platform monitoring & tenant management</p>
      </div>
      ...
      <div style={{
        ...
        <KpiCard value={kpis?.expiredSubscriptions || 0} label="Expired Subs" color="#F44336" />
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 20, fontWeight: 600, color: '#333' }}>Tenants</h2>
          <a href="/tenants" style={{ color: '#007AFF', fontSize: 14, fontWeight: 500 }}>
            Manage All →
          </a>
        </div>
